...
# -*- coding: utf-8 -*-
#
# cellmaps_vnn documentation build configuration file, created by
...
init_file = os.path.join('..', 'cellmaps_vnn', '__init__.py')
...
htmlhelp_basename = 'cellmaps_vnndoc'
...
latex_documents = [
    (master_doc, 'cellmaps_vnn.tex',
     u'cellmaps_vnn Documentation',
