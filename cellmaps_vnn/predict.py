...
class VNNPredict:
    ...
    def add_subparser(subparsers):
        ...
        parser.add_argument('--traindir', required=True, help='Path to RO-Crate with the trained model', type=str)
    ...
    def run(self):
        ...
        """
        try:
            model = os.path.join(self._theargs.traindir, 'model_final.pt')
            std = os.path.join(self._theargs.traindir, 'std.txt') if self._theargs.std is None else self._theargs.std
