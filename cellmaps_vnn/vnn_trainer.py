...
class VNNTrainer:
    ...
    def train_model(self):
        ...
        optimizer = torch.optim.AdamW(self.model.parameters(), lr=self.data_wrapper.lr, betas=(0.9, 0.99), eps=1e-05,
        ...
        for epoch in range(self.data_wrapper.epochs):
            ...
            _gradnorms = torch.empty(len(train_loader)).cuda(
                self.data_wrapper.cuda)  # tensor for accumulating grad norms from each batch in this epoch
            ...
            for i, (inputdata, labels) in enumerate(train_loader):
                ...
                if train_predict.size()[0] == 0:
                    ...
                    train_label_gpu = torch.cat([train_label_gpu, cuda_labels], dim=0)  # TODO: train_label_gpu
                ...
                total_loss.backward()  # TODO: to check
            ...
            for i, (inputdata, labels) in enumerate(val_loader):
                ...
                if val_predict.size()[0] == 0:
                    ...
                    val_label_gpu = torch.cat([val_label_gpu, cuda_labels], dim=0)  # TODO: check
